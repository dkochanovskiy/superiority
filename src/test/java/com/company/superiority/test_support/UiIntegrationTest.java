package com.company.superiority.test_support;

import com.company.superiority.SuperiorityApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.superiority.screen")
@ContextConfiguration(classes = {SuperiorityApplication.class, UiTestAssistConfiguration.class})
